...
df <- read_excel("R Weather Graphic Input.xlsx", sheet = "Philadelphia")
glimpse(df)
...
p <- p +
  labs(title = "Philadelphia's Weather in 2022" )+
  annotate("text", x = 23, y = 105, label = "Temperature", size=4, fontface="bold")+
  annotate("text", x = 80, y = 102, 
           label = "Data represents average daily temperatures for Philadelphia in 2022.", size=3, colour="gray30")
